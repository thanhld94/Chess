...
<body id="matchesPage">
	...
	<div id="wrapper">
	      ...
	      <div id="navContainer">
	        <div id="navigation">
	          <ul>
	            ...
	            <li id="playPageLink"><a href="../../play.html">Play</a></li>
	    ...
	    <div id="content">
	    	...
	    	<p>
	    		Upload chess games for sharing purposes.
			</p>

			<div id="chessboard">
	    		<img src="../../images/immortal.png" alt="chess game image">
	    	</div>
	    	
<?php
    include_once("../../phps/comments.php");
?>
